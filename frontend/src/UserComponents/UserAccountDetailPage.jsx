...
export default function UserAccountDetailPage() {
  ...
  const logoutHandler = async () => {
    try {
        const response = await axios.post('https://dm-gallery-backend-api.onrender.comckend-api.onrender.com/api/v1/users/logout/',{},{withCredentials:true});
...
useEffect(() => {
    const fetchUser = async () => {
        try {
            setError(false);
            const response = await axios.get("https://dm-gallery-backend-api.onrender.comckend-api.onrender.comckend-api.onrender.com/api/v1/users/current-user-page",{withCredentials:true});
